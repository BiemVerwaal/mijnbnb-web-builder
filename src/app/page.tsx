      ...
      <header className="bg-white/88 backdrop-blur-xl border-b border-brand/10 shadow-sm">
        <div className="max-w-5xl mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="font-extrabold text-lg text-ink">Mijn-BnB Web Builder</h1>
      ...
      <main className="max-w-5xl mx-auto px-6 py-8">
        ...
        {projects.length === 0 && !showNew ? (
          <div className="text-center py-20">
            ...
            <h2 className="text-xl font-bold text-ink mb-2">Nog geen projecten</h2>
            <p className="text-ink-soft mb-6">Maak je eerste BnB gast-app aan om te beginnen.</p>
